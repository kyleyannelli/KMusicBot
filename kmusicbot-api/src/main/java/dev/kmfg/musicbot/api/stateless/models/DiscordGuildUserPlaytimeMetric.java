...
public class DiscordGuildUserPlaytimeMetric {
    ...
    @Expose
    private final String GUILD_ICON_HASH;
    @Expose
    ...
    public DiscordGuildUserPlaytimeMetric(String guildName, long guildId, long listenedSeconds, long timesInitialized, String guildIconHash) {
        this.GUILD_NAME = guildName;
        this.GUILD_ICON_HASH = guildIconHash;
